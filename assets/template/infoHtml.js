export default function createInfoHTML({ name, rating, adr_address, phone_number, distanceCampground, place_id, url }) {
  ...
  <span>${phone_number}</span>
        <span>${Math.round(distanceCampground / 1609)} miles </span><br>
